    ...
    function getQuote($address)
    {
        ...
        if ($status)
        {
            ...
            $quote_data['newpost'] = array(
                ...
                'text' => $this->currency->format($this->tax->calculate($this->config->get('newpost_cost'), $this->config->get('newpost_tax_class_id'), $this->config->get('config_tax')), $this->session->data['currency'])
            );
